        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <h1 class="font-bold text-xl text-gray-800 tracking-tight">BacaNovel</h1>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-slot name="content">
                            @auth
                                ...
                                @if (Auth::user()->role === 'author')
                                    <x-dropdown-link :href="route('author.dashboard')">
                                        Author Dashboard
                                    </x-dropdown-link>
                                @endif
                            @endauth
                ...
                @else
                    <div class="flex items-center gap-3">
                        <a href="{{ route('login') }}" class="px-3 py-1.5 font-semibold text-sm rounded-md">Login</a>
                        <a href="{{ route('register') }}" class="px-3 py-1.5 font-semibold text-sm rounded-md text-white bg-blue-500 hover:bg-blue-600">Register</a>
                    </div>
                @endauth
            </div>
