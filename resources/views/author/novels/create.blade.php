<x-app-layout>
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <form action="{{ route('author.novels.store') }}" method="post" enctype="multipart/form-data" class="bg-white rounded-md p-6 space-y-4">
                @csrf
                ...
                <div x-data="{
                    ...
                    <div x-show="coverUrl !== null" style="display: none;" class="mb-2">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1.5 rounded-md font-medium transition-colors">Save</button>
            </form>
        </div>
    </div>
</x-app-layout>
